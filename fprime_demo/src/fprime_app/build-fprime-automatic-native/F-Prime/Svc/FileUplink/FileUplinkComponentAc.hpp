...
namespace Svc {
    ...
    public Fw::ActiveComponentBase
  {
    ...
    PRIVATE:
      ...
      FwIndexType m_InvalidReceiveModeThrottle;

      //! Throttle for PacketOutOfBounds
      FwIndexType m_PacketOutOfBoundsThrottle;

      //! Throttle for PacketOutOfOrder
      FwIndexType m_PacketOutOfOrderThrottle;

      //! Throttle for PacketDuplicate
      FwIndexType m_PacketDuplicateThrottle;

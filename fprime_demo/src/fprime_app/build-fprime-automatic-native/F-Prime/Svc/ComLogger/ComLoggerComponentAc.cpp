...
namespace Svc {
  ...
  FwIndexType ComLoggerComponentBase ::
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_CLOSEFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    ) const
  {
    ...
    if (this->m_logOut_OutputPort[0].isConnected()) {
      ...
      _status = file.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 240));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_logOut_OutputPort[0].isConnected()) {
      ...
      _status = validationFile.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 240));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

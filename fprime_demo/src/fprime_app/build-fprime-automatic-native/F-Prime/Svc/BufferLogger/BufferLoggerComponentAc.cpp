...
namespace Svc {
  ...
  FwIndexType BufferLoggerComponentBase ::
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_comIn_InputPort));
  }
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_BL_OPENFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_BL_CLOSEFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_BL_SETLOGGING));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_BL_FLUSHFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    log_DIAGNOSTIC_BL_LogFileClosed(const Fw::StringBase& file) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = file.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = validationFile.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 256));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

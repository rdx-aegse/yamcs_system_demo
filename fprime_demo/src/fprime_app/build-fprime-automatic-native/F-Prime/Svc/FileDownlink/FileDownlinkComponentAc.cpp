...
namespace Svc {
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_SENDFILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_CANCEL));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_SENDPARTIAL));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    log_WARNING_HI_FileOpenError(const Fw::StringBase& fileName) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = fileName.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 100));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );
    ...
    ) const
  {
    ...
    if (this->m_eventOut_OutputPort[0].isConnected()) {
      ...
      _status = sourceFileName.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 100));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

      _status = destFileName.serialize(_logBuff, FW_MIN(FW_LOG_STRING_MAX_SIZE, 100));
      FW_ASSERT(
        _status == Fw::FW_SERIALIZE_OK,
        static_cast<FwAssertArgType>(_status)
      );

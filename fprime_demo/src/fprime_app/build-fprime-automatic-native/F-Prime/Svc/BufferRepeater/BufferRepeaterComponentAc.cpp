...
namespace Svc {
  ...
  FwIndexType BufferRepeaterComponentBase ::
    getNum_portIn_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_portIn_InputPort));
  }
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_portOut_OutputPort));
  }

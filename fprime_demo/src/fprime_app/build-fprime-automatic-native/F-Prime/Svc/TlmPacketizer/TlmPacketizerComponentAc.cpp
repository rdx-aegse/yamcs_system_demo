...
namespace Svc {
  ...
  FwIndexType TlmPacketizerComponentBase ::
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_SET_LEVEL));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_SEND_PKT));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
  ...
  void TlmPacketizerComponentBase ::
    log_WARNING_LO_NoChan(U32 Id) const
  {
    // Get the time
    Fw::Time _logTime;
  ...
  void TlmPacketizerComponentBase ::
    log_ACTIVITY_HI_LevelSet(U32 id) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_timeGetOut_OutputPort[0].isConnected()) {

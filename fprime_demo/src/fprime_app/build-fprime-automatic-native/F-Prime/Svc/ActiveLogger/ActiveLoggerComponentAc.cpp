...
namespace Svc {
  ...
  FwIndexType ActiveLoggerComponentBase ::
  ...
  void ActiveLoggerComponentBase ::
    log_ACTIVITY_HI_ID_FILTER_ENABLED(U32 ID) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void ActiveLoggerComponentBase ::
    log_WARNING_LO_ID_FILTER_LIST_FULL(U32 ID) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void ActiveLoggerComponentBase ::
    log_ACTIVITY_HI_ID_FILTER_REMOVED(U32 ID) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void ActiveLoggerComponentBase ::
    log_WARNING_LO_ID_FILTER_NOT_FOUND(U32 ID) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {

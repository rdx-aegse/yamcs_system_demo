...
namespace Svc {
    ...
    )
  {
    ...
    // Serialize for IPC
    _status = msg.serialize(static_cast<FwEnumStoreType>(CMD_PRM_SAVE_FILE));
    FW_ASSERT (
      _status == Fw::FW_SERIALIZE_OK,
      static_cast<FwAssertArgType>(_status)
    );
  ...
  void PrmDbComponentBase ::
    log_ACTIVITY_HI_PrmIdUpdated(U32 Id) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void PrmDbComponentBase ::
    log_FATAL_PrmDbFull(U32 Id) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {
  ...
  void PrmDbComponentBase ::
    log_ACTIVITY_HI_PrmIdAdded(U32 Id) const
  {
    // Get the time
    Fw::Time _logTime;
    if (this->m_Time_OutputPort[0].isConnected()) {

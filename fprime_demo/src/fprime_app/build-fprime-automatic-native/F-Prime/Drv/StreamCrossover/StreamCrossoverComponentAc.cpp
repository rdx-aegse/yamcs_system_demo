...
namespace Drv {
    ...
    init(FwEnumStoreType instance)
  {
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_streamIn_InputPorts());
      port++
    ) {
      ...
      this->m_streamIn_InputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_errorDeallocate_OutputPorts());
      port++
    ) {
      ...
      this->m_errorDeallocate_OutputPort[port].setObjName(portName.toChar());
#endif
    }
    ...
    for (
      FwIndexType port = 0;
      port < static_cast<FwIndexType>(this->getNum_streamOut_OutputPorts());
      port++
    ) {
      ...
      this->m_streamOut_OutputPort[port].setObjName(portName.toChar());
#endif
    }
  }
  ...
  Drv::InputByteStreamRecvPort* StreamCrossoverComponentBase ::
    get_streamIn_InputPort(FwIndexType portNum)
  {
    FW_ASSERT(
  ...
  FwIndexType StreamCrossoverComponentBase ::
    getNum_streamIn_InputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_streamIn_InputPort));
  }
  ...
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_errorDeallocate_OutputPort));
  }

  FwIndexType StreamCrossoverComponentBase ::
    getNum_streamOut_OutputPorts() const
  {
    return static_cast<FwIndexType>(FW_NUM_ARRAY_ELEMENTS(this->m_streamOut_OutputPort));
  }
  ...
  bool StreamCrossoverComponentBase ::
    isConnected_errorDeallocate_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_errorDeallocate_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)
  ...
  bool StreamCrossoverComponentBase ::
    isConnected_streamOut_OutputPort(FwIndexType portNum)
  {
    FW_ASSERT(
      portNum < this->getNum_streamOut_OutputPorts(),
      static_cast<FwAssertArgType>(portNum)
  ...
  void StreamCrossoverComponentBase ::
    log_WARNING_HI_StreamOutError(Drv::SendStatus sendStatus) const
  {
    // Get the time
    Fw::Time _logTime;

...
#include <demo/Top/demoTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    demo::setupTopology(inputs);
    demo::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    demo::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}

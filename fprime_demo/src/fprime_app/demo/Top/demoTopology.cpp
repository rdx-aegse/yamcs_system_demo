...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::demo_blockDrv::WARN, PingEntries::demo_blockDrv::FATAL, "blockDrv"},
    {PingEntries::demo_tlmSend::WARN, PingEntries::demo_tlmSend::FATAL, "chanTlm"},
    {PingEntries::demo_cmdDisp::WARN, PingEntries::demo_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::demo_cmdSeq::WARN, PingEntries::demo_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::demo_eventLogger::WARN, PingEntries::demo_eventLogger::FATAL, "eventLogger"},
    {PingEntries::demo_fileDownlink::WARN, PingEntries::demo_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::demo_fileManager::WARN, PingEntries::demo_fileManager::FATAL, "fileManager"},
    {PingEntries::demo_fileUplink::WARN, PingEntries::demo_fileUplink::FATAL, "fileUplink"},
    {PingEntries::demo_prmDb::WARN, PingEntries::demo_prmDb::FATAL, "prmDb"},
    {PingEntries::demo_rateGroup1::WARN, PingEntries::demo_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::demo_rateGroup2::WARN, PingEntries::demo_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::demo_rateGroup3::WARN, PingEntries::demo_rateGroup3::FATAL, "rateGroup3"},
};
...
// Public functions for use in main program are namespaced with deployment name demo
namespace demo {

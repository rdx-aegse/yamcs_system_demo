// ======================================================================
// \title  demoTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DEMO_DEMOTOPOLOGY_HPP
#define DEMO_DEMOTOPOLOGY_HPP
// Included for access to demo::TopologyState and demo::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <demo/Top/demoTopologyDefs.hpp>

// Remove unnecessary demo:: qualifications
 ...
 * demo::TopologyState see: demoTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type demo::TopologyState see: demoTopologyDefs.hpp.
 *
